...
// Website als Link gerendert wird (siehe app/agb/page.js) und im PDF-Anhang
// der Bestätigungsmail als reiner Text (siehe lib/legal/pdf.js).
...
export const AGB_SECTIONS = [
  ...
  },
  {
    ...
    paragraphs: [
      "Die Darstellung der Angebote auf der Website ist kein bindendes Angebot des Anbieters, sondern eine Aufforderung zur Bestellung. Mit dem Absenden des Buchungsformulars übermittelt die Kundin oder der Kunde eine Anfrage (bei Einzelstunden eine Terminanfrage); der Vertrag kommt erst mit der Bestätigung durch den Anbieter (per E-Mail) zustande. Das gilt für Pakete und Einzelstunden gleichermaßen.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "Es gelten die zum Zeitpunkt der Buchung angegebenen Preise. Der Anbieter ist Kleinunternehmer im Sinne des § 19 UStG; die Preise enthalten daher keine Umsatzsteuer. Pakete werden nach Vertragsschluss per Rechnung abgerechnet und per Überweisung bezahlt. Einzelstunden werden nach Terminbestätigung individuell abgerechnet.",
    ],
  },
  {
