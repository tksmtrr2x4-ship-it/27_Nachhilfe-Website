...
const CONSENT_LABEL = {
  ...
  contract: "Erziehungsberechtigung, AGB und Widerrufsbelehrung",
  earlyStart: "Vorzeitiger Leistungsbeginn",
  eInvoice: "Elektronische Rechnungen per E-Mail",
  invoiceCommitment: "Zahlung per Rechnung (Zahlungsverpflichtung)",
};
