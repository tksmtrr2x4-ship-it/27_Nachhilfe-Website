...
// gespeist werden daraus sowohl die Seite /widerruf als auch der PDF-Anhang
// der Bestellbestätigungs-E-Mail (§ 312f Abs. 2 BGB, siehe lib/legal/pdf.js).
// Wortlaut nicht ändern, ohne die Seite UND das PDF zu prüfen.
...
export const WIDERRUF_SECTIONS = [
  {
    ...
    paragraphs: [
      ...
      "Um Ihr Widerrufsrecht auszuüben, müssen Sie mich (Jill Manuel Hils, Aixheimer Straße 2, 78056 Villingen-Schwenningen, j.hils@lernsprung-vs.de, Telefon +49 179 4328302) mittels einer eindeutigen Erklärung (z. B. ein mit der Post versandter Brief oder eine E-Mail) über Ihren Entschluss, diesen Vertrag zu widerrufen, informieren. Sie können dafür das beigefügte Muster-Widerrufsformular verwenden, das jedoch nicht vorgeschrieben ist. Zur Wahrung der Widerrufsfrist reicht es aus, dass Sie die Mitteilung über die Ausübung des Widerrufsrechts vor Ablauf der Widerrufsfrist absenden.",
    ],
  },
  {
...
export const WIDERRUF_MUSTER = {
  ...
  to: "An: Jill Manuel Hils, Aixheimer Straße 2, 78056 Villingen-Schwenningen, j.hils@lernsprung-vs.de",
  declaration:
