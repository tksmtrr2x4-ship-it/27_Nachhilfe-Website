...
export async function sendMail({ to, subject, text, html }) {
  if (!isMailConfigured()) {
    // Kein Empfänger/Betreff im Log – beides kann personenbezogen sein
    // (E-Mail-Adresse bzw. Name im Betreff einer Terminanfrage).
    console.warn("Mailversand übersprungen (SMTP nicht konfiguriert).");
    return { skipped: true };
  }
