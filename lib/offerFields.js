...
export function normalizeOfferInput(body, { partial } = { partial: false }) {
  ...
  // Ab welcher Klassenstufe das Angebot buchbar ist – frei pro Angebot,
  // leer/0 bedeutet keine Angabe.
  if (has("minClass")) {
    out.minClass = Number.isFinite(Number(body.minClass)) && body.minClass !== null && body.minClass !== ""
      ? Number(body.minClass)
      : null;
  }
